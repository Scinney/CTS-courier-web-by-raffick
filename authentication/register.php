    ...
    <div class="login-container">
        ...
        <form id="loginForm" class="login-form" method="POST">
            <div class="form-group">
                ...
                <input type="text" id="username" name="first_name" placeholder="Enter your First Name" required>
            </div>
            <div class="form-group">
                <label for="second_name">Surname</label>
                <input type="text" id="username" name="second_name" placeholder="Enter your Surname" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="gender" placeholder="Enter your Gender" required>
            </div>
            <div class="form-group">
                <label for="role">Role</label>
                <input type="text" id="username" name="role" placeholder="Enter your Role" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="address" placeholder="Enter your Address" required>
            </div>
        ...
        <script>
            ...
            document.getElementById("loginForm").addEventListener("submit", function(event) {
                ...
                if (username === "admin" && password === "admin123") {
                    alert("Login successful! Welcome to CTS Courier.");
